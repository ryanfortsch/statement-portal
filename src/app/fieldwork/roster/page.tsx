      ...
      <section className="max-w-[900px] mx-auto px-10" style={{ width: '100%', paddingTop: 28, paddingBottom: 48 }}>
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', marginTop: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'baseline' }}>
            ...
            {trade === 'creative' && (
              <Link href="/fieldwork/shoots" style={{ fontSize: 13, color: 'var(--tide-deep)', fontWeight: 600, textDecoration: 'none' }}>
                Shoots &amp; pay →
              </Link>
            )}
            <Link href={`/fieldwork/hiring?trade=${trade}`} style={{ fontSize: 13, color: newApplicants > 0 ? 'var(--signal)' : 'var(--tide-deep)', fontWeight: newApplicants > 0 ? 600 : 400, textDecoration: 'none' }}>
            ...
            <>
              ...
              {ps!.owedCents > 0 && (
                isCreative ? (
                  ...
                  <Link href="/fieldwork/shoots" style={{ marginTop: 5, display: 'inline-block', fontSize: 11.5, color: 'var(--tide-deep)', fontWeight: 600, textDecoration: 'none' }}>
