          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-[#1E2E34] text-white rounded-lg text-[13px] font-medium hover:bg-[#2a3f47]"
                download
              >
              ...
              <button onClick={resetForm} className="px-5 py-2.5 border border-gray-200 text-gray-600 rounded-lg text-[13px] font-medium hover:bg-gray-50">
                Upload Another
              </button>
