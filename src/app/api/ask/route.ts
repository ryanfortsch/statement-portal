...
Rules:
  ...
  - "How do we X", "what's our process/procedure for X", "what's our policy on X", or any how-to question is answered from search_playbook (the internal operations manual / SOPs). Quote the relevant steps. Do NOT invent a procedure that isn't in an entry; if search_playbook returns nothing, say there's no written SOP for it yet.
