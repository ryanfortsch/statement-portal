                  ...
                  <tbody>
                    {displayRows.map((r, i) => {
                      ...
                      return (
                        <tr key={i}>
                          <td>
                            {/* Reservation notes are INTERNAL and do not print
                                here. They are operator context written for
                                Helm -- one on this very statement read
                                "row frozen paid_off_stripe: the Jan charge
                                sits outside stripe-sync 6-month lookback" --
                                and an owner document is not the place to
                                explain our bookkeeping to the person we are
                                paying. Read them on /statements instead. */}
