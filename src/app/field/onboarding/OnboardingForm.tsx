  ...
  return (
    <>
      <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: 22, maxWidth: 480 }}>
        ...
        {/* No separate "home base" field: the W-9 city/state/ZIP below doubles
            as the home base for "near you" packet ranking (geocoded town-level
            in completeOnboarding). One address, typed once. */}
